...
|6.2: software use an accepted coding standard or convention | y |
...
|14.1: accept contributions (e.g. bug fixes, enhancements, documentation updates, tutorials) from people who are not part of your project | y |
|14.2: have a contributions policy | y |
|14.3: contributions' policy publicly available | y |
