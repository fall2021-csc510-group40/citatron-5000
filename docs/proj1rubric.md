...
|2.1:  name of your project/software unique | (y/n) evidence |
|2.2: project/software name free from trademark violations | (y/n) evidence |
|3.1: software available as a package that can be deployed without building it | (y/n) evidence |
|3.2: software available for free | | (y/n) evidence |
|3.3: source code publicly available to download, either as a downloadable bundle or via access to a source code repository | (y/n) evidence |
|3.4: software hosted in an established, third-party repository like GitHub | (y/n) evidence |
|4.1: documentation clearly available on your website or within your software | (y/n) evidence |
...
|4.7: documentation under revision control with your source code | (y/n) evidence |
...
|5.5: have a ticketing system to manage bug reports and feature requests | (y/n) evidence |
|5.6: project's ticketing system publicly visible to your users, so they can view bug reports and feature requests | (y/n) evidence |
|6.1:  software’s architecture and design modular | (y/n) evidence |
|6.2: software use an accepted coding standard or convention | (y/n) evidence |
|7.1: software allow data to be imported and exported using open data formats (GIF, HTML, etc.) | (y/n) evidence |
|7.2: software allow communications using open communications protocols (HTTP, FTP, etc.) | (y/n) evidence |
|8.1: software cross-platform compatible | (y/n) evidence |
...
|10.1: source code stored in a repository under revision control | (y/n) evidence |
|10.2: source code release a snapshot of the repository | (y/n) evidence |
|10.3: releases tagged in the repository | (y/n) evidence |
|10.4: a branch of the repository that is always stable | (y/n) evidence |
|10.5: back-up your repository | (y/n) evidence |
